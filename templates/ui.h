...
LV_IMG_DECLARE(
    ui_img_menerima_semua_payment_yang_dapat_menggunakan_qris_png);    // assets/Menerima semua payment yang dapat menggunakan QRIS.png
LV_IMG_DECLARE(ui_img_1944009510);    // assets/Menerima semua payment yang dapat menggunakan QRIS (1).png
